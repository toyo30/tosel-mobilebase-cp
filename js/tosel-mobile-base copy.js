...
( () => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			objs: {
				...
				messageA: document.querySelector('.prob-title'),
				messageB: document.querySelector('.prob-img'),
				messageC: document.querySelector('.prob-text'),
			},
			values: {
	...
	function scrollLoop() {
		...
		if (yOffset > prevScrollHeight + sceneInfo[currentScene].scrollHeight) {
			enterNewScene = true;
			console.log(enterNewScene, 'enterNewScene');
			currentScene++;
			document.body.setAttribute('id', `show-scene-${currentScene}`);
		}
